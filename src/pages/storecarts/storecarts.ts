...
/**
 * Generated class for the StorecartsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-storecarts',
  templateUrl: 'storecarts.html',
})
export class StorecartsPage {
	carts = [];
	total:number = 0;
	isCheckAll = false
	checkTxt = '全选'
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad StorecartsPage');
  }
